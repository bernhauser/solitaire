...
fun KlondikeState.drawFromStock(): KlondikeState? {
...
fun KlondikeState.recycleWaste(): KlondikeState? {
...
fun KlondikeState.moveToTableau(source: TableauMoveSource, destColumn: Int): KlondikeState? {
...
fun KlondikeState.moveToFoundation(source: FoundationMoveSource): KlondikeState? {
...
fun KlondikeState.isWon(): Boolean = foundations.size == 4 && foundations.all { it.size == Rank.entries.size }

fun KlondikeState.hasAnyImmediateMove(): Boolean {
  if (waste.isNotEmpty()) {
...
fun KlondikeState.canAutoComplete(): Boolean {
...
fun KlondikeState.nextAutoCompleteSource(): FoundationMoveSource? {
