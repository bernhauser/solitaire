...
import se.bernhauser.solitaire.ui.board.*
import se.bernhauser.solitaire.game.klondike.KlondikeState
import se.bernhauser.solitaire.game.Suit
import se.bernhauser.solitaire.game.klondike.TableauMoveSource
import se.bernhauser.solitaire.game.klondike.moveToFoundation
import se.bernhauser.solitaire.game.klondike.moveToTableau
import se.bernhauser.solitaire.game.klondike.nextAutoCompleteSource
...
fun KlondikeBoard(
  ...
  suspend fun animateWasteToFoundation(snapshot: KlondikeState, durationMs: Int): Boolean {
  ...
  suspend fun animateTableauTopToFoundation(snapshot: KlondikeState, col: Int, durationMs: Int): Boolean {
...
private fun drawnCardsPreview(state: KlondikeState): List<se.bernhauser.solitaire.game.Card> {
...
private fun DragSource.movedCardSuit(state: KlondikeState): Suit? = when (this) {
...
private fun totalCardCount(state: KlondikeState): Int {
