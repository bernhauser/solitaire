...
class StockWasteTest {
  ...
  private fun stateWith(stock: List<Card>, waste: List<Card> = emptyList()): KlondikeState =
    KlondikeState(stock = stock, waste = waste, foundations = emptyFoundations, tableau = emptyTableau)
