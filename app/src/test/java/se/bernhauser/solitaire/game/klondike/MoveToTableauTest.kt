...
import se.bernhauser.solitaire.game.klondike.TableauMoveSource.FoundationTop
import se.bernhauser.solitaire.game.klondike.TableauMoveSource.TableauRun
import se.bernhauser.solitaire.game.klondike.TableauMoveSource.WasteTop
...
class MoveToTableauTest {
  ...
  ) = KlondikeState(stock = emptyList(), waste = waste, foundations = foundations, tableau = tableau)
